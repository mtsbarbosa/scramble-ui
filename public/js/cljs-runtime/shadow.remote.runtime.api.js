...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16971 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16971(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_16973 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_16973(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_16974 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_16974(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_16975 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_16975(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16976 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16976(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16978 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16978(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__16968,callback){
var map__16969 = p__16968;
var map__16969__$1 = cljs.core.__destructure_map(map__16969);
var input = map__16969__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16969__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16969__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
