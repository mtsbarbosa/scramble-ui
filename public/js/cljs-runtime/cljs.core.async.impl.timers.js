...
var i_17200 = (0);
while(true){
if((i_17200 < arr.length)){
(arr[i_17200] = null);

var G__17205 = (i_17200 + (1));
i_17200 = G__17205;
continue;
} else {
}
...
var i_17228 = (self__.level + (1));
while(true){
if((i_17228 <= (new_level + (1)))){
(update[i_17228] = self__.header);

var G__17229 = (i_17228 + (1));
i_17228 = G__17229;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_17230 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_17230[i]));
} else {
x__$2.forward.push((((i < links_17230.length))?(links_17230[i]):null));
}

if((i < links_17230.length)){
(links_17230[i] = x__$2);
} else {
links_17230.push(x__$2);
}
...
var i_17235 = (0);
while(true){
if((i_17235 <= self__.level)){
var links_17236 = (update[i_17235]).forward;
if((x__$1 === (((i_17235 < links_17236.length))?(links_17236[i_17235]):null))){
(links_17236[i_17235] = (x__$1.forward[i_17235]));

var G__17241 = (i_17235 + (1));
i_17235 = G__17241;
continue;
} else {
var G__17243 = (i_17235 + (1));
i_17235 = G__17243;
continue;
}
} else {
...
var G__17254 = nx;
var G__17255 = (level__$1 - (1));
x = G__17254;
level__$1 = G__17255;
continue;
} else {
var G__17256 = x;
var G__17257 = (level__$1 - (1));
x = G__17256;
level__$1 = G__17257;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__17259 = nx;
var G__17260 = (level__$1 - (1));
x = G__17259;
level__$1 = G__17260;
continue;
} else {
var G__17262 = x;
var G__17263 = (level__$1 - (1));
x = G__17262;
level__$1 = G__17263;
continue;
}
