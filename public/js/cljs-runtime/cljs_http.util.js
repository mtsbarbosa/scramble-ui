...
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11719,(0),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11719,(1),null);
 ...
 */
cljs_http.util.build_url = (function cljs_http$util$build_url(p__11724){
var map__11725 = p__11724;
var map__11725__$1 = cljs.core.__destructure_map(map__11725);
var scheme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"scheme","scheme",90199613));
var server_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"server-name","server-name",-1012104295));
var server_port = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"server-port","server-port",663745648));
var uri = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"uri","uri",-774711847));
var query_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11725__$1,new cljs.core.Keyword(null,"query-string","query-string",-1018845061));
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__11727 = (new goog.Uri());
G__11727.setScheme(cljs.core.name((function (){var or__4253__auto__ = scheme;
...
G__11727.setDomain(server_name);

G__11727.setPort(server_port);

G__11727.setPath(uri);

G__11727.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__11732_SHARP_,p2__11729_SHARP_){
var vec__11734 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__11729_SHARP_,/:\s+/);
...
return p1__11732_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__11732_SHARP_,clojure.string.lower_case(k),v);
}
