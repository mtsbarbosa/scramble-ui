...
var len__4864__auto___12300 = arguments.length;
var i__4865__auto___12301 = (0);
while(true){
if((i__4865__auto___12301 < len__4864__auto___12300)){
args__4870__auto__.push((arguments[i__4865__auto___12301]));

var G__12302 = (i__4865__auto___12301 + (1));
i__4865__auto___12301 = G__12302;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12266){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12267,G__12268,seq12266__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12278_SHARP_){
return (!((cljs.core.meta(p1__12278_SHARP_) == null)));
})))){
...
var map__12280 = opts;
var map__12280__$1 = cljs.core.__destructure_map(map__12280);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12280__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12281){var _e__11388__auto__ = e12281;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e12283){var _e__11388__auto__ = e12283;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12286 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12287 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12287);

try{var map__12288 = opts;
var map__12288__$1 = cljs.core.__destructure_map(map__12288);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12288__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12286);
}});
...
var temp__5751__auto___12321 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___12321)){
var managed_print_level_12322 = temp__5751__auto___12321;
var _STAR_print_level_STAR__orig_val__12295_12323 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__12296_12324 = managed_print_level_12322;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__12296_12324);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12290_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12290_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__12295_12323);
}} else {
job_fn();
}
