...
var G__22234 = o;
reagent.impl.template.goog$module$goog$object.set(G__22234,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__22337__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__22337 = function (var_args){
var args = null;
...
while (G__22340__i < G__22340__a.length) {G__22340__a[G__22340__i] = arguments[G__22340__i + 0]; ++G__22340__i;}
  args = new cljs.core.IndexedSeq(G__22340__a,0,null);
} 
return G__22337__delegate.call(this,args);};
G__22337.cljs$lang$maxFixedArity = 0;
G__22337.cljs$lang$applyTo = (function (arglist__22341){
var args = cljs.core.seq(arglist__22341);
return G__22337__delegate(args);
});
...
var G__22243 = o;
reagent.impl.template.goog$module$goog$object.set(G__22243,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__22346.cljs$lang$applyTo = (function (arglist__22348){
...
var G__22260 = props;
var G__22260__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22260,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22260);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22260__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22264 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22264,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22264;
}
})(),id_class);
...
var G__22268 = (cljs.core.count(argv) - first_child);
switch (G__22268) {
case (0):
...
var vec__22270 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22270,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22270,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22270,(2),null);
...
var temp__5757__auto___22390 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___22390 == null)){
} else {
var key_22392 = temp__5757__auto___22390;
(jsprops.key = key_22392);
}
...
var temp__5757__auto___22393 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___22393 == null)){
} else {
var key_22398 = temp__5757__auto___22393;
(jsprops.key = key_22398);
}
...
var temp__5757__auto___22404 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___22404 == null)){
} else {
var key_22406 = temp__5757__auto___22404;
(jsprops.key = key_22406);
}
...
var temp__5757__auto___22422 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___22422 == null)){
} else {
var key_22423 = temp__5757__auto___22422;
(jsprops.key = key_22423);
}
...
var temp__5757__auto___22424 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___22424 == null)){
} else {
var key_22425 = temp__5757__auto___22424;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22288_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22288_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22292 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22292,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22292,(1),null);
...
break;
default:
var G__22436 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22437 = compiler;
v = G__22436;
compiler = G__22437;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template22317 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template22317 = (function (opts,id,fn_to_element,parse_fn,meta22318){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22317.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22319,meta22318__$1){
var self__ = this;
var _22319__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22317(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22318__$1));
}));

(reagent.impl.template.t_reagent$impl$template22317.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22319){
var self__ = this;
var _22319__$1 = this;
return self__.meta22318;
}));

(reagent.impl.template.t_reagent$impl$template22317.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22317.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22317.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22317.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22317.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22317.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22318","meta22318",-1095840380,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22317.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22317.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22317");

(reagent.impl.template.t_reagent$impl$template22317.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template22317");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22317.
 */
reagent.impl.template.__GT_t_reagent$impl$template22317 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template22317(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22318){
return (new reagent.impl.template.t_reagent$impl$template22317(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta22318));
});

}

return (new reagent.impl.template.t_reagent$impl$template22317(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
