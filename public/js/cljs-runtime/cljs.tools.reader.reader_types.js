...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_14401 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_14401(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_14407 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_14407(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14410 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_14410(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14414 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_14414(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14419 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_14419(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14421 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_14421(reader);
}
});
...
var G__14477 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__14478 = s.append(c);
c = G__14477;
s = G__14478;
continue;
}
