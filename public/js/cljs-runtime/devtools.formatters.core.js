...
}catch (e14973){var _e__11388__auto__ = e14973;
return false;
...
}catch (e14976){var _e__11388__auto__ = e14976;
return false;
...
}catch (e14985){var _e__11388__auto__ = e14985;
return false;
...
}catch (e14993){var _e__11388__auto__ = e14993;
return false;
...
}catch (e15004){var _e__11388__auto__ = e15004;
return false;
}})())){
...
}catch (e15026){var _e__11388__auto__ = e15026;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__15055 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__15056 = (function (){var or__4253__auto__ = config;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__15056);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__15055);
}});
});
...
while (G__15086__i < G__15086__a.length) {G__15086__a[G__15086__i] = arguments[G__15086__i + 0]; ++G__15086__i;}
  args = new cljs.core.IndexedSeq(G__15086__a,0,null);
} 
