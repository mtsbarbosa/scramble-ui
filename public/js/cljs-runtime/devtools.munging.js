...
var o11800 = temp__5751__auto__;
var temp__5751__auto____$1 = (o11800["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o11801 = temp__5751__auto____$1;
return (o11801["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__11346__auto__ = f;
return (o__11346__auto__["toString"]).call(o__11346__auto__);
} else {
return "";
}
}catch (e11810){var _ = e11810;
return "";
}});
...
try{var o__11346__auto___12204 = t;
(o__11346__auto___12204["cljs$lang$ctorPrWriter"]).call(o__11346__auto___12204,t,writer);
}catch (e11834){var __12205 = e11834;
}
...
var char_code = (function (){var o__11346__auto__ = (new String(char$));
return (o__11346__auto__["charCodeAt"]).call(o__11346__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__11346__auto__ = String;
return (o__11346__auto__["fromCharCode"]).call(o__11346__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11858 = num_code;
switch (G__11858) {
case (1):
return (185);
...
var o__11346__auto__ = String;
return (o__11346__auto__["fromCharCode"]).call(o__11346__auto__,superscript_code);
});
/**
...
}catch (e11872){var _e__11388__auto__ = e11872;
return false;
}})())){
...
var vec__11873 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11873,(0),null);
...
var len__4864__auto___12221 = arguments.length;
var i__4865__auto___12223 = (0);
while(true){
if((i__4865__auto___12223 < len__4864__auto___12221)){
args__4870__auto__.push((arguments[i__4865__auto___12223]));

var G__12227 = (i__4865__auto___12223 + (1));
i__4865__auto___12223 = G__12227;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11925){
var vec__11926 = p__11925;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11926,(0),null);
...
var G__12230 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__12231 = cljs.core.butlast(remaining_tokens);
name_tokens = G__12230;
remaining_tokens = G__12231;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11913){
var G__11915 = cljs.core.first(seq11913);
var seq11913__$1 = cljs.core.next(seq11913);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11915,seq11913__$1);
}));
...
var vec__11940 = cljs.core.split_with((function (p1__11936_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__11936_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11940,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11940,(1),null);
...
var vec__11949 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11949,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11949,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__12233 = cljs.core.rest(remaining_tokens);
var G__12234 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__12233;
name_tokens = G__12234;
continue;
} else {
...
var vec__11976 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11976,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11976,(1),null);
var vec__11979 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11979,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11979,(1),null);
var vec__11982 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11982,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11982,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11982,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11982,(3),null);
...
var vec__12026 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12026,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12026,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12026,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12026,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12026,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12026,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__12036 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12036,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12036,(1),null);
var vec__12040 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12040,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12040,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__12053 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__12053) : devtools.munging.parse_fn_info_deep.call(null,G__12053));
})()));
}
} else {
return fn_info;
...
var G__12250 = (arity + (1));
var G__12251 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__12076){
var vec__12078 = p__12076;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12078,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12078,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12096_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__12096_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12097_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__12097_SHARP_);
}),sorted_infos);
...
var args__4870__auto__ = [];
var len__4864__auto___12255 = arguments.length;
var i__4865__auto___12256 = (0);
while(true){
if((i__4865__auto___12256 < len__4864__auto___12255)){
args__4870__auto__.push((arguments[i__4865__auto___12256]));

var G__12257 = (i__4865__auto___12256 + (1));
i__4865__auto___12256 = G__12257;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__12102){
var vec__12103 = p__12102;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12103,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq12099){
var G__12100 = cljs.core.first(seq12099);
var seq12099__$1 = cljs.core.next(seq12099);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12100,seq12099__$1);
}));
...
var map__12124 = options;
var map__12124__$1 = cljs.core.__destructure_map(map__12124);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12124__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12124__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12124__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12124__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__12125 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12125,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12125,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12125,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12125,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12125,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12125,(5),null);
...
var o__11346__auto__ = f;
return (o__11346__auto__["getBasis"]).call(o__11346__auto__);
});
/**
...
}catch (e12146){var _e__11388__auto__ = e12146;
...
var G__12272 = (obj[cljs.core.first(path)]);
var G__12273 = cljs.core.rest(path);
obj = G__12272;
path = G__12273;
continue;
} else {
...
var _STAR_ = (function (accum,p__12163){
var vec__12165 = p__12163;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12165,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12165,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__12181){
var vec__12182 = p__12181;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12182,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12182,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12182,(2),null);
...
var post_process = (function (p__12191){
var vec__12192 = p__12191;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12192,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12192,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12188_SHARP_){
return (obj[cljs.core.first(p1__12188_SHARP_)]);
}),sorted_matches);
